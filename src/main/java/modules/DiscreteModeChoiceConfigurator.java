...
public class DiscreteModeChoiceConfigurator {
    ...
    static public void configureAsSubtourModeChoiceReplacement(Config config) {
        for (StrategyConfigGroup.StrategySettings strategy : config.strategy().getStrategySettings()) {
            if (strategy.getStrategyName().equals(DefaultPlanStrategiesModule.DefaultStrategy.SubtourModeChoice)) {
    ...
    static public void configureAsModeChoiceInTheLoop(Config config, double replanningRate) {
        ...
        StrategyConfigGroup.StrategySettings dmcStrategy = new StrategyConfigGroup.StrategySettings();
        ...
        StrategyConfigGroup.StrategySettings selectorStrategy = new StrategyConfigGroup.StrategySettings();
        selectorStrategy.setStrategyName(DefaultPlanStrategiesModule.DefaultSelector.KeepLastSelected);
    ...
    public static void checkModeChoiceInTheLoop(StrategyConfigGroup strategyConfigGroup) {
        ...
        if (!activeStrategies.contains(DefaultPlanStrategiesModule.DefaultSelector.KeepLastSelected)) {
            throw new IllegalStateException(
        ...
        activeStrategies.remove(DefaultPlanStrategiesModule.DefaultSelector.KeepLastSelected);
        activeStrategies.remove(DiscreteModeChoiceModule.STRATEGY_NAME);
        activeStrategies.remove(DefaultPlanStrategiesModule.DefaultStrategy.ReRoute);
